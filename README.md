...
**只举剑圣不好对比，再举例两个前期最高常态AB的职业（天界蛇原怒者，用碎虫者；还有突变斗士，BD在友情链接里，靠席拉圣疗来驱逐疲劳）**
...
- 常驻AB = 7BAB + 10力量调整值 + 1武器专攻（斩矛）+ 2秘银震电斩矛 + 1加速术 + 2士气（英雄气概） + 2夹击 + 2包抄 - 2猛力攻击 -1体型 + 2破敌 + 2武器训练= 27，这里要注意，只有圣武士/魔战士/精魂猎手才能在5级有锐锋（其他职业至少要8级才能出精通重击，战斗祭祀4级就有锐锋但是武器附魔时间太短），前期的重击率已经远超其他职业了（有祝福武器可以重击自动确认），搭配包抄的重击借机，效果拔群。
